//////////////////////////////////////////////////////////////////////////////
//     
//  File name :     program724.cpp
//  Descreption :   Customised Virtual File System.(CVFS)
...
void InitialiseUAREA()
{
    ...
    cout<<"OPTIMUS CVFS : UAREA initialised succesfully\n";
}
...
void InitialiseSuperblock()
{
    ...
    cout<<"OPTIMUS CVFS : Superblock initialised succesfully\n";
}
...
void CreateDILB()
{
    ...
    cout<<"OPTIMUS CVFS : DILB created succesfully\n";
}
...
void StartAuxilaryDataInitialisation()
{
    ...
    cout<<"OPTIMUS CVFS : Auxilary data initalised succesfully\n";
}
...
{
    printf("---------------------------------------------------------\n");
    printf("----------- Command Manual of OPTIMUS CVFS -----------\n");
    printf("---------------------------------------------------------\n");

    printf("man : It is used to display the specific manual page of command\n");
    printf("exit : It is used to terminate the shell of OPTIMUS CVFS\n");
    printf("clear : It is used to clear the console of OPTIMUS CVFS\n");
            ...
            )
{
    ...
    {
        printf("Description : This command is used to terminate the OPTIMUS CVFS\n");
...
int main()
{
    ...
    while(1)
    {
        ...
        if(iCount == 1)
        {
            ...
            {
                printf("Thank you for using OPTIMUS CVFS\n");
        ...
        {
            // OPTIMUS CVFS > creat Ganesh.txt 3
